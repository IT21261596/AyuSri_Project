...
class Medidetailsactivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_medidetailsactivity)
    ...
    private fun deleteRecord(mediID: String) {
        ...
        mTask.addOnSuccessListener {
            ...
            val intent = Intent(this,MedecineFetch::class.java)
    ...
    private fun openUpdateDialog(mediID: String, mediTopic: String) {
        ...
        val mDialogView = inflater.inflate(R.layout.updatedis_dialog,null)
    ...
    private fun updateEmpData(disId: String, topic:String,dis:String) {
        ...
        val disInfo = Medicine(disId,topic,dis)
